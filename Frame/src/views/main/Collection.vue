<template>
  <div class="pt-5 w-75 m-auto">
    ...
    <p class="text-secondary lh-lg py-5">
      ...
      labore commodi ipsum nesciunt, ducimus illo facere accusamus qui eligendi
      dolorem odio saepe dignissimos ullam?
    </p>
  </div>
  ...
  <Transition name="fade">
    <div class="modal-vue" v-if="isSettingsModalActive">
      ...
      <div class="overlay overlay-settings" @click="closeSettingsModal()"></div>
    </div>
  </Transition>
  <!--Settings Modal End -->
  <LastViewed />
